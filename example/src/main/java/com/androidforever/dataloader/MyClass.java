...
public class MyClass
{
    public static void main(String[] args) throws UnsupportedEncodingException, InterruptedException
    {
        ...
        Cache.getInstance(FSCache.class).addToCache("user:pedja", user);
        ...
        CacheDataProvider<FSCache, User> fsCacheDataProvider = new CacheDataProvider<>("user:pedja", FSCache.class);
